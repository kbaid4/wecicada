...
const ServiceProvider = () => {
  ...
  const venueTypes = [
    { name: 'Catering Services', image: '9.png', path: '/CateringService' },
    { name: 'AV & Production Services', image: '10.png' , path: '/AVP'},
    { name: 'Decor & Design Services', image: '11.png' , path: '/DDS'},
    { name: 'Entertainment & Performers', image: '12.png' , path: '/EntPrf'},
